"""
Direct Flow for Google Maps MCP: User → LLM Tool Call → Tool Result → Final Assistant Message
Implements the exact 4-step flow requested, targeting the Google Maps MCP server.
"""
...
class GoogleMapsFlowAgent:
    """Agent that implements the exact 4-step flow for Google Maps MCP"""
    ...
    async def step3_tool_execution(self, tool_call: Dict[str, Any]) -> str:
        ...
        try:
            ...
            print(f"📤 Tool Result: {tool_result[:2000]}..." if isinstance(tool_result, str) and len(tool_result) > 2000 else f"📤 Tool Result: {tool_result}")
            return tool_result
    ...
    async def process_user_request(self, user_input: str) -> str:
        ...
        print("=" * 60)
        print("🚀 Starting Google Maps 4-Step Flow")
        print("=" * 60)
...
async def main():
    """Main function to demonstrate the 4-step flow with Google Maps MCP"""
    print("🚀 Google Maps 4-Step Flow Agent")
    print("=" * 40)
